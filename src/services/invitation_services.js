...
const createAdminService = async (req, session) => {
  const reqBody = req.body;
...
const createResellerService = async (req, session) => {
  const reqBody = req.body;
...
module.exports = { createUserService, checkTempPassword, createAdminService, createResellerService };
